...
class course_module_viewed extends \core\event\course_module_viewed {
    ...
    protected function init(): void {
        ...
        $this->data["objecttable"] = "linkcollection";
    }
    ...
    public static function get_name(): string {
        return get_string("eventcoursemoduleviewed", "mod_linkcollection");
    }
    ...
    public function get_description(): string {
        return "The user with id '{$this->userid}' viewed the link collection activity with course module id " .
